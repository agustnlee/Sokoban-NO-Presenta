...
- **🏺 Cajas Frágiles (Jarrón):** Tienen una resistencia limitada a un máximo de 10 empujes, visible en todo momento sobre la imagen. Cada empuje válido reduce su resistencia. Si llega a cero, el nivel termina en derrota.
...
- Cada uso genera una **penalización de 10 puntos** sobre el puntaje final.

---

## 🗺️ Niveles y Progresión

El juego cuenta con una campaña de **10 niveles** accesibles desde el menú principal o desde el selector de niveles individual. La dificultad presenta una curva progresiva:
...
- **💯 Puntaje:** Se muestra en tiempo real en el HUD junto al contador de movimientos y undos utilizados. Se calcula así:
  - Puntaje base: **1000 puntos**
  - Cada movimiento: **-1 punto**
  - Cada uso del Undo: **-10 puntos**
  - El puntaje mínimo visible en el HUD es 0, pero internamente puede volverse negativo — lo que activa la derrota al completar el nivel.
...
- **Tomás Augusto Romero:** Desarrollo del gestor de sonidos y entidades no movibles, organizacion del UML, y soporte.
- **Facundo:** Testing, Proofreading y soporte.
